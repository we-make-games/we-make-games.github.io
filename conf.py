...
BLOG_TITLE = "We Make Games"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://we-make-games.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://we-make-games.github.io/"
BLOG_EMAIL = "info@example.com"
BLOG_DESCRIPTION = "Let's make some simple games together"  # (translatable)

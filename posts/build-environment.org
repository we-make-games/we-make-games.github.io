...
Make sure to install make, cmake, gcc, SDL2, SDL2_mixer and SDL2_TTF.
...
My favorite editor is emacs (http://www.gnu.org/software/emacs/) but you can use whatever editor works for you but it
